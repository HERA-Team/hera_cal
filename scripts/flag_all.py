...
ap.add_argument(
    "outfilename",
    type=str,
    help="path to new visibility file to write out completely flagged data",
)
ap.add_argument(
    "--clobber",
    default=False,
...
ap.add_argument(
    "--fill_data_with_zeros",
    default=False,
    action="store_true",
    help="Fills the data array with zeros.",
)
ap.add_argument(
    "--fill_nsamples_with_zeros",
    default=False,
    action="store_true",
    help="Fills the nsamples array with zeros.",
)
