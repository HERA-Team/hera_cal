...
echo badants_yid=qsub -t 1-72 ~/src/heracal/scripts/batch_get_bad_ants.sh -a ${EX_ANTS_Y} /data4/paper/HERA2015/${jd}/zen.${jd}.*.yy.HH.uvc
badants_yid=`qsub -t 1-72 ~/src/heracal/scripts/batch_get_bad_ants.sh -a ${EX_ANTS_Y} /data4/paper/HERA2015/${jd}/zen.${jd}.*.yy.HH.uvc`
badants_yid=`echo ${badants_yid} | cut -f 1 -d . | cut -f 3 -d ' '`
echo badants_xid=qsub -t 1-72 ~/src/heracal/scripts/batch_get_bad_ants.sh -a ${EX_ANTS_X} /data4/paper/HERA2015/${jd}/zen.${jd}.*.xx.HH.uvc
badants_xid=`qsub -t 1-72 ~/src/heracal/scripts/batch_get_bad_ants.sh -a ${EX_ANTS_X} /data4/paper/HERA2015/${jd}/zen.${jd}.*.xx.HH.uvc`
badants_xid=`echo ${badants_yid} | cut -f 1 -d . | cut -f 3 -d ' '`


# Firstcal
echo firstcal_yid=qsub -hold_jid ${badants_yid} -t 1-72 ~/src/heracal/scripts/batch_firstcal.sh -p yy /data4/paper/HERA2015/${jd}/zen.${jd}.*.yy.HH.uvc
...
echo firstcal_xid=qsub -hold_jid ${badants_xid} -t 1-72 ~/src/heracal/scripts/batch_firstcal.sh -p xx  /data4/paper/HERA2015/${jd}/zen.${jd}.*.xx.HH.uvc
