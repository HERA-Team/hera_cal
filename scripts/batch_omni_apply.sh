...
for f in ${ARGS}; do
    echo ~/src/hera_cal/scripts/omni_apply.py -p $POL_VAL --omnipath=${f}.omni.calfits --extension="O" ${f}
    ~/src/hera_cal/scripts/omni_apply.py -p $POL_VAL --omnipath=${f}.omni.calfits --extension="O" ${f}
done
