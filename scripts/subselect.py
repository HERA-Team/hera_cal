...
freq_grp.add_argument(
    "--freq-spws",
    type=str,
    help="Comma-separated list of frequency spws to select, eg '0~100,200~300'.",
    default=None,
)
...
time_grp.add_argument(
    "--lst-in-hours",
    action="store_true",
    help="whether LST bounds are in hours (otherwise radians)",
)

pol_grp = ap.add_argument_group("Polarization Selection")
pol_grp.add_argument(
    "--pols",
    type=str,
    help="Comma-separated list of polarizations to select.",
    default=None,
)

ant_grp = ap.add_argument_group("Antenna Selection")
ant_grp.add_argument(
    "--antennas",
    type=str,
    help="Comma-separated list of antenna ranges to select.",
    default=None,
)
ant_grp.add_argument(
    "--calfile",
    type=str,
    help="Path to calfile to use for antenna selection.",
    default=None,
)
...
bl_grp.add_argument(
    "--min-bl-length",
    type=float,
    help="Minimum baseline length to select, metres",
    default=None,
)
bl_grp.add_argument(
    "--max-bl-length",
    type=float,
    help="Maximum baseline length to select, metres",
    default=None,
)
bl_grp.add_argument(
    "--min-ew-length",
    type=float,
    help="Minimum EW baseline length to select, metres",
    default=None,
)
bl_grp.add_argument(
    "--max-ew-length",
    type=float,
    help="Maximum EW baseline length to select, metres",
    default=None,
)
...
check_grp.add_argument(
    "--check",
    action="store_true",
    help="Check output file for consistency with input file.",
)
check_grp.add_argument(
    "--check-acceptability",
    action="store_true",
...
def select(
    ...
    if (
        ...
        or only_autos
        or only_cross
        or min_bl_length is not None
        or max_bl_length is not None
        or min_ew_length is not None
        or max_ew_length is not None
...
run_with_profiling(select, args, **kw)
