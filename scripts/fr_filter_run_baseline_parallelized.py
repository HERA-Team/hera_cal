fr_filter#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Copyright 2021 the HERA Project
# Licensed under the MIT License

"""Command-line drive script for hera_cal.fr_filter with baseline parallelization. Only performs DAYENU Filtering"""

from hera_cal import frf
import sys
import hera_cal.io as io

parser = frf.fr_filter_argparser(multifile=True)
...
if len(baseline_list) > 0:
    ...
    if isinstance(a.calfile_list, str) and a.calfile_list.lower() == 'none':
        a.calfile_list = None
    # Run Xtalk Filter
    fr_filter.load_fr_filter_and_write_baseline_list(a.datafilelist, calfile_list=a.calfilelist, avg_red_bllens=True,
