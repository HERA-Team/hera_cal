...
frf.load_tophat_frfilter_and_write(ap.datafilelist, calfile_list=ap.calfilelist, avg_red_bllens=True,
                                   ...
                                   mainlobe_radius=ap.mainlobe_radius, uvbeam=ap.uvbeam, percentile_low=ap.percentile_low, percentile_high=ap.percentile_high,
                                   clean_flags_in_resid_flags=True, select_mainlobe=ap.select_mainlobe, mainlobe_width=ap.mainlobe_width, **filter_kwargs)
