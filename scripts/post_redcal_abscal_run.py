...
post_redcal_abscal_run(a.data_file, a.redcal_file, a.model_files, output_file=a.output_file, nInt_to_load=a.nInt_to_load,
                       data_solar_horizon=a.data_solar_horizon, model_solar_horizon=a.model_solar_horizon, min_bl_cut=a.min_bl_cut, 
                       max_bl_cut=a.max_bl_cut, edge_cut=a.edge_cut, tol=a.tol, phs_max_iter=a.phs_max_iter, refant=a.refant,
