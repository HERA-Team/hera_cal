...
setup_args = {
    ...
    'scripts': ['scripts/extract_hh.py', 'scripts/post_redcal_abscal_run.py',
                ...
                'scripts/query_ex_ants.py', 'scripts/dayenu_xtalk_filter_run.py',
                'scripts/dayenu_xtalk_filter_run_baseline_parallelized.py',
                ...
                'scripts/dpss_delay_filter_run.py', 'scripts/chunk_cal_files.py', 'scripts/chunk_data_files.py'],
