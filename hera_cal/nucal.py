...
class RadialRedundancy:
    ...
    def filter_radial_groups(
        self, min_nbls=1, min_bl_cut=None, max_bl_cut=None, ex_bls=None
    ):
        """
        ...
        ex_bls : list of tuples, default=None
            List of baseline tuples to exclude from the radially redundant groups
        """
        ...
        for group in self._radial_groups:
            ...
            for bl in group:
                if (max_bl_cut is None or self.baseline_lengths[bl] < max_bl_cut) and (
                    ...
                    if ex_bls is None or bl not in ex_bls:
...
def compute_spatial_filters_single_group(
    group, freqs, bls_lengths, spatial_filter_half_width=1, eigenval_cutoff=1e-12
):
    """
...
def compute_spatial_filters(
    radial_reds, freqs, spatial_filter_half_width=1, eigenval_cutoff=1e-12, cache={}
):
    """
