...
class Test_lstbin(object):
    ...
    def test_config_lst_bin_files(self):
         ...
         (lst_grid, dlst, file_lsts, begin_lst, lst_arrs, time_arrs) = lstbin.config_lst_bin_files(data_lists, dlst=0.0007046864745507975, atol=1e-10, lst_start=5.178260914725223, lst_stop=None, fixed_lst_start=False, verbose=True,
                                                                                                   ntimes_per_file=2)
