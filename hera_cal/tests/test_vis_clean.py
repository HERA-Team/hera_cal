...
class Test_VisClean(object):
    ...
    def test_time_chunk_from_baseline_chunks(self, tmp_path):
        ...
        for filenum, file in enumerate(datafiles):
            ...
            tfrf.load_tophat_frfilter_and_write(datafiles, baseline_list=baselines, calfile_list=cals,
        ...
        tfrf.load_tophat_frfilter_and_write(datafile_list=os.path.join(DATA_PATH, "test_input/zen.2458101.46106.xx.HH.OCR_53x_54x_only.uvh5"),
