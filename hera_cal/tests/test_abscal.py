...
class Test_AbsCal:
    ...
    def test_apply_gains(self):
        ...
        del gains[(24, 'Jxx')]
        corr_data = abscal.apply_gains(self.AC.data, gains, rm_missing=True)
        nt.assert_true((24, 25, 'xx') not in corr_data)
        corr_data = abscal.apply_gains(self.AC.data, gains, rm_missing=False)
        nt.assert_true((24, 25, 'xx') in corr_data)
