...
class Test_Reflection_Fitter(unittest.TestCase):
    ...
    def test_reflection_modeling(self):
        ...
        # non-even Nfreqs
        RF = hc.Reflection_Fitter(self.uvd.select(frequencies=np.unique(self.uvd.freq_array)[1:], inplace=False))
