...
def apply_cal(data_infilename, data_outfilename, new_calibration, old_calibration = None, filetype = 'miriad',
    ...
    recalibrate_in_place(data, data_flags, new_gains, new_flags, old_gains=old_gains, gain_convention=gain_convention)
