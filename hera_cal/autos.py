...
def read_and_write_autocorrelations(
    infile,
    outfile,
    calfile=None,
...
def extract_autos_argparser():
    ...
    a = argparse.ArgumentParser(
        description="Extract autocorrelations from a .uvh5 file and write to disk as a .uvh5 file, optionally calibrating"
    )
    a.add_argument(
        "infile",
        type=str,
    ...
    a.add_argument(
        "outfile",
        type=str,
        help="path to .uvh5 output data file containing only autocorrelations",
    )
    a.add_argument(
        "--calfile",
        type=str,
