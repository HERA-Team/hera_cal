...
def _filter_argparser():
    ...
    clean_options = a.add_argument_group(title='Options for CLEAN (only used when mode == "clean")')
    ...
    cache_options = a.add_argument_group(title='Options for caching (only used when mode == "dayenu" or "dpss_leastsq")')
    ...
    cache_options.add_argument("--max_contiguous_edge_flags", type=int, default=1, help="Skip integrations with at least this number of contiguous edge flags.")
    return a
