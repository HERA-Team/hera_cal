...
def post_redcal_abscal_run(data_file, redcal_file, model_files, raw_auto_file=None, data_is_redsol=False, model_is_redundant=False, output_file=None,
                           ...
                           edge_cut=0, tol=1.0, phs_max_iter=100, phs_conv_crit=1e-6, refant=None, clobber=True, add_to_history='', verbose=True, use_abs_amp_lincal=True,
                    ...
                    for tinds in tind_groups:
                        ...
                        if not np.all(list(flags.values())):
                            ...
                            delta_gains = post_redcal_abscal(model, data, data_wgts, rc_flags_subset, edge_cut=edge_cut, tol=tol,
                                                             phs_max_iter=phs_max_iter, phs_conv_crit=phs_conv_crit, verbose=verbose, use_abs_amp_lincal)
...
def post_redcal_abscal_argparser():
    ...
    a.add_argument("--use_abs_amp_lincal", defualt=True, action="store_false", help="finish calibration with an unbiased amplitude lincal step")
